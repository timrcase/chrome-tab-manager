...
- `storage`: Used to persist saved tabs, backup snapshots, the closed-tab archive, and extension settings on your device.
- `alarms`: Used to schedule periodic tab backups and automatic archive purges.
